...
def compute_4h_attack_stats(
    ...
    selected["h4_start_merge"] = pd.to_datetime(selected["h4_start"], errors="coerce").dt.tz_localize(None)
    ...
    dmerge["daily_end_merge"] = pd.to_datetime(dmerge["daily_end"], errors="coerce").dt.tz_localize(None)
    selected = selected.dropna(subset=["h4_start_merge"]).copy()
    dmerge = dmerge.dropna(subset=["daily_end_merge"]).copy()
    selected["h4_start_merge"] = pd.to_datetime(selected["h4_start_merge"], errors="coerce")
    dmerge["daily_end_merge"] = pd.to_datetime(dmerge["daily_end_merge"], errors="coerce")
